...
INSERT INTO available_interviewers
  (day_id, interviewer_id)
SELECT 1 AS day_id, interviewers.interviewer_id
FROM ( SELECT id AS interviewer_id
  FROM interviewers
  ORDER BY RANDOM() LIMIT 5 ) interviewers;

INSERT INTO available_interviewers
  (day_id, interviewer_id)
SELECT 2 AS day_id, interviewers.interviewer_id
FROM ( SELECT id AS interviewer_id
  FROM interviewers
  ORDER BY RANDOM() LIMIT 5 ) interviewers;
...
INSERT INTO available_interviewers
  (day_id, interviewer_id)
SELECT 3 AS day_id, interviewers.interviewer_id
FROM ( SELECT id AS interviewer_id
  FROM interviewers
  ORDER BY RANDOM() LIMIT 5 ) interviewers;
...
INSERT INTO available_interviewers
  (day_id, interviewer_id)
SELECT 4 AS day_id, interviewers.interviewer_id
FROM ( SELECT id AS interviewer_id
  FROM interviewers
  ORDER BY RANDOM() LIMIT 5 ) interviewers;
...
INSERT INTO available_interviewers
  (day_id, interviewer_id)
SELECT 5 AS day_id, interviewers.interviewer_id
FROM ( SELECT id AS interviewer_id
  FROM interviewers
  ORDER BY RANDOM() LIMIT 5 ) interviewers;